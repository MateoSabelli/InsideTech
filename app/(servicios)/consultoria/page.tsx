    ...
    <div className="">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="pt-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center justify-center pt-8 max-w-5xl mx-auto">
            ...
            <div className="rounded-lg  flex items-center justify-center">
              <Image
                src="/consultoria/datcenter_1.jpg"
                alt="Virtualizacion"
                width={1200}
                height={500}
        ...
        <div className="py-12">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center justify-center max-w-5xl mx-auto pt-8">
            ...
            <div className="rounded-lg p-6 flex items-center justify-center">
              <Image
                src="/consultoria/img_opensource.jpg"
                alt="Open Source"
                width={400}
                height={400}
                className="rounded-lg"
          ...
          <div className=" text-center max-w-5xl mx-auto pt-16">
            <h3 className="text-3xl font-semibold max-w-6xl mx-auto text-[#39506D] mb-8">
              Contáctanos y descubrí cómo nuestro servicio de consultoría puede
              optimizar y mejorar tu operación de TI
            </h3>
