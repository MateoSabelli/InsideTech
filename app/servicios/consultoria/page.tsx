      ...
      features={[
        {
          ...
          description: "Análisis detallado de tu infraestructura actual para identificar oportunidades de mejora.",
        },
        {
          title: "Arquitectura e implementación",
          description: "Diseño e implementación de soluciones on-premise, cloud o híbridas según tus necesidades.",
        },
        {
          title: "Optimización de redes y servidores",
          description: "Mejora del rendimiento y la eficiencia de tu infraestructura actual.",
        },
        {
          title: "Migraciones a nuevos entornos",
          description: "Transición segura y eficiente a nuevas plataformas o tecnologías.",
        },
      ]}
    />
  );
