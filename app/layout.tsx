    ...
    <html lang="en">
      ...
      >
         <div className="fixed inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute -left-1/4 -top-1/4 w-[600px] h-[600px] bg-gradient-to-b from-blue-400/50 to-transparent rounded-full blur-3xl animate-move" />
          ...
          <div className="absolute -left-1/4 bottom-1/4 w-[600px] h-[600px] bg-gradient-to-t from-blue-400/35 to-transparent rounded-full blur-3xl animate-move animation-delay-6000" />
