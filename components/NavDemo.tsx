...
export function NavDemo() {
  return (
    <div className="text-white flex items-center justify-between w-full fixed top-0 left-0 right-0 px-4 h-20  backdrop-blur-sm z-20">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          ...
          <Button className="bg-primary text-white hover:bg-[#00E5E5]/90 px-6">
            Cotizar servicio
          </Button>
        </div>
          ...
          <Sheet>
            ...
            <SheetContent className="bg-gray-900/95 backdrop-blur-sm text-white">
              <nav className="flex flex-col space-y-4">
                ...
                <Button className="bg-[#00E5E5] text-white hover:bg-[#00E5E5]/90 w-full">
                  Cotizar servicio
                </Button>
              </nav>
            </SheetContent>
