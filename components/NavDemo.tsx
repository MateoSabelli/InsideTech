...
const components: { title: string; href: string; description: string }[] = [
  {
    ...
    description: "Gestiona incidencias, solicitudes y problemas de forma ágil, con flujos de trabajo automatizados y una interfaz intuitiva.",
  },
  {
    title: "InvGate Assets",
    href: "/productos/invgateAssets",
    description: "Gestiona hardware, software y licencias en un solo lugar, reduciendo costos y mejorando la productividad.",
  },
  {
    title: "Red Hat",
  ...
  },
  {
    ...
    description: "Anticípate a los problemas y toma decisiones estratégicas basadas en datos, con la potencia de dos líderes del software open source.",
  },
]
